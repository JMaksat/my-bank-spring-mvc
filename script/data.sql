...
insert into bank.directory (dir_id, dir_group, dir_type, description, date_created, date_modified, is_active, user_id)
values (19, 'PAPERS', 'PASSPORT', 'Passport', '2016-01-01', '2016-01-01', true, 'scott');
insert into bank.directory (dir_id, dir_group, dir_type, description, date_created, date_modified, is_active, user_id)
values (20, 'PAPERS', 'IDENTITY_CARD', 'Identity document', '2016-01-01', '2016-01-01', true, 'scott');
insert into bank.directory (dir_id, dir_group, dir_type, description, date_created, date_modified, is_active, user_id)
values (21, 'PAPERS', 'DRIVING_LICENCE', 'Driving licence', '2016-01-01', '2016-01-01', true, 'scott');
alter sequence bank.directory_dir_id_seq restart with 22;


insert into bank.customer_info values (0,	'MyBank',	'First',	'Branch',	'2015-12-31',	null,	true, 'scott',	'2016-01-02');
insert into bank.customer_info values (1,	'Scott',	'Ridley',	'Alien',	'1937-11-30',	'2016-01-08',	true,	'scott',	'2016-01-02');
